...
scripts = [
    ("Space is Silent", "space galaxy", "Did you know space is completely silent? There is no atmosphere, so sound cannot travel. An explosion next to you in space would be totally silent. Every atom in your body was forged inside an ancient star. You are literally made of stardust. Like and Subscribe for more amazing facts!"),
    ...
    ("Milky Way", "milky way galaxy", "Our Milky Way galaxy contains over 200 billion stars. It takes light 100,000 years to cross from one end to the other. And our galaxy is just one of two trillion galaxies in the observable universe. Like and Subscribe for more amazing facts!"),
]
...
print(f"✅ اترفع: https://youtube.com/watch?v={response['id']}")
